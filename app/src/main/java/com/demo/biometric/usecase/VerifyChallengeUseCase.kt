...
import com.demo.biometric.data.remote.repository.VerifyChallengeRepository
import kotlinx.coroutines.flow.Flow
import javax.inject.Inject
import javax.inject.Singleton

@Singleton
class VerifyChallengeUseCase
@Inject
constructor(private val repository: VerifyChallengeRepository) :
    BaseUseCase<Outcome>() {
